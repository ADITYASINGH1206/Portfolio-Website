  ...
  return (
    <div ref={containerRef} className="relative h-[200vh] w-full bg-background">
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col md:flex-row items-center justify-center gap-12 px-8 overflow-hidden max-w-6xl mx-auto">
        ...
        <div className="flex-1 relative h-64 flex items-center justify-center md:justify-start w-full">
          
          {/* Phase 1: Small Intro */}
          <motion.div 
            className="absolute left-0 w-full text-center md:text-left"
            style={{ opacity: intro1Opacity, y: intro1Y, scale: intro1Scale }}
          >
          ...
          >
            ...
            <p className="text-lg md:text-xl text-foreground/80 font-light leading-relaxed max-w-xl">
